...
<head>
    ...
    <div class="pcontainer">
        <div class="row">
            ...
            <div class="col-4">
                    <img src="images/1BTshirt3.png" alt="">
                
            </div>
        </div>
        <div class="row">
            <div class="col-4">
                    <img src="images/1BTshirt5.png" alt="">
                
            </div>
            <div class="col-4">
                    <img src="images/1BTshirt4.png" alt="">
    ...
    <form action="insertCart.php" method="post">
        <h4>Lava Roadster BT-Shirt Navy<a href="cart.php"><i class="fa fa-shopping-cart" aria-hidden="true" ></i></a></h4>
            <div class="rating">
            ...
            <input type="hidden" name="name" value="Lava Roadster BT-Shirt Navy">
...
<div class="scontainer">
    ...
    <div class="row">
        ...
        <div class="col-4">
        <a href="2BT.php">
            <img src="images/2BTshirt3.png" alt="">
