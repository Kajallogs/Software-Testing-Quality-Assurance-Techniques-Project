...
<head>
    ...
    <div class="pcontainer">
        ...
        <div class="row">
            <div class="col-4">
                    <img src="images/2BTshirt5.png" alt="">
                
            </div>
            <div class="col-4">
                    <img src="images/2BTshirt4.png" alt="">
    ...
    <form action="insertCart.php" method="post">
        <h4>Lava Roadster BT-Shirt <a href="cart.php"><i class="fa fa-shopping-cart" aria-hidden="true" ></i></a></h4>
            <div class="rating">
