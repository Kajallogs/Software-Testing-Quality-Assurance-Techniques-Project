...
<head>
    ...
    <div class="pcontainer">
        <div class="row">
            ...
            <div class="col-4">
                    <img src="images/1GTshirt3.png" alt="">
                
            </div>
        </div>
        <div class="row">
            <div class="col-4">
                    <img src="images/1GTshirt5.png" alt="">
                
            </div>
            <div class="col-4">
                    <img src="images/1GTshirt4.png" alt="">
    ...
    <form action="insertCart.php" method="post">
        <h4>Lava Roadster GT-Shirt Black<a href="cart.php"><i class="fa fa-shopping-cart" aria-hidden="true" ></i></a></h4>
            <div class="rating">
            ...
            <input type="hidden" name="name" value="Lava Roadster GT-Shirt Black">
