...
<head>
    ...
    <div class="pcontainer">
        <div class="row">
            ...
            <div class="col-4">
                    <img src="images/1kurta3.png" alt="">
                
            </div>
        </div>
        <div class="row">
            <div class="col-4">
                    <img src="images/1kurta2.png" alt="">
                
            </div>
            <div class="col-4">
                    <img src="images/1kurta4.png" alt="">
    ...
    <form action="insertCart.php" method="post">
        <h4>Gerua Kurta and Chunri<a href="cart.php"><i class="fa fa-shopping-cart" aria-hidden="true" ></i></a></h4>
            <div class="rating">
            ...
            <input type="hidden" name="name" value="Gerua Kurta and Chunri">
